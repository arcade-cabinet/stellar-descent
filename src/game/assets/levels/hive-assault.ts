...
export const HIVE_ASSAULT_ASSETS: AssetEntry[] = [
  ...
  {
    id: 'modular/wall_a',
    path: '/models/environment/modular/Wall_A.glb',
    category: 'model',
    sizeKB: 300,
  },
  {
    id: 'modular/wall_b',
    path: '/models/environment/modular/Wall_B.glb',
    category: 'model',
    sizeKB: 300,
  },
  {
    id: 'modular/floor_a',
    path: '/models/environment/modular/Floor_A.glb',
    category: 'model',
    sizeKB: 250,
  },
  {
    id: 'modular/door_a',
    path: '/models/environment/modular/Door_A.glb',
    category: 'model',
    sizeKB: 200,
  },
  {
    id: 'modular/column_a',
    path: '/models/environment/modular/Column_A.glb',
    category: 'model',
    sizeKB: 150,
  },
  ...
  // ============================================================================
  {
    ...
    path: '/models/props/atmospheric/hallway 4.glb',
    category: 'model',
    sizeKB: 4355,
  },
  ...
  // ============================================================================
  {
    ...
    path: '/textures/levels/hive-assault/DiamondPlate005A_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/assault/diamond_normal',
    path: '/textures/levels/hive-assault/DiamondPlate005A_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/assault/diamond_roughness',
    path: '/textures/levels/hive-assault/DiamondPlate005A_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 200,
  },

  {
    ...
    path: '/textures/levels/hive-assault/Concrete018_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/assault/concrete_normal',
    path: '/textures/levels/hive-assault/Concrete018_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/assault/concrete_roughness',
    path: '/textures/levels/hive-assault/Concrete018_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 200,
  },

  {
    ...
    path: '/textures/levels/hive-assault/Metal014_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/assault/metal_normal',
    path: '/textures/levels/hive-assault/Metal014_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/assault/metal_roughness',
    path: '/textures/levels/hive-assault/Metal014_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/assault/metal_metalness',
    path: '/textures/levels/hive-assault/Metal014_1K-JPG_Metalness.jpg',
    category: 'texture',
    sizeKB: 200,
  },

  {
    ...
    path: '/textures/levels/hive-assault/PaintedMetal003_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/assault/painted_normal',
    path: '/textures/levels/hive-assault/PaintedMetal003_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/assault/painted_roughness',
    path: '/textures/levels/hive-assault/PaintedMetal003_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 200,
  },

  {
    ...
    path: '/textures/levels/hive-assault/skybox.exr',
    category: 'texture',
    sizeKB: 2000,
  },
  ...
  // ============================================================================
  {
    ...
    path: '/models/spaceships/Imperial.glb',
    category: 'model',
    sizeKB: 3500,
  },
  {
    id: 'spaceship/executioner',
    path: '/models/spaceships/Executioner.glb',
    category: 'model',
    sizeKB: 3500,
  },
  ...
  },
  {
    ...
    path: '/models/environment/modular/DoorDoubleLong_Wall_SideA.glb',
    category: 'model',
    sizeKB: 16,
  },
  {
    id: 'modular/door_sgl_long_a',
    path: '/models/environment/modular/DoorSingleLong_Wall_SideA.glb',
    category: 'model',
    sizeKB: 16,
  },
  {
  ...
  },
  {
    ...
    path: '/models/environment/modular/DoorSingle_Wall_SideB.glb',
    category: 'model',
    sizeKB: 11,
  },
  {
    id: 'modular/column_slim',
    path: '/models/environment/modular/Column_Slim.glb',
    category: 'model',
    sizeKB: 14,
  },
  {
    id: 'modular/roof_corner_pipes',
    path: '/models/environment/modular/RoofTile_Corner_Pipes.glb',
    category: 'model',
    sizeKB: 27,
  },
  {
    id: 'modular/roof_inner_pipes',
    path: '/models/environment/modular/RoofTile_InnerCorner_Pipes.glb',
    category: 'model',
    sizeKB: 27,
  },
  {
    id: 'modular/roof_sides_pipes',
    path: '/models/environment/modular/RoofTile_Sides_Pipes.glb',
    category: 'model',
    sizeKB: 18,
  },
  {
    id: 'modular/roof_orange_vent',
    path: '/models/environment/modular/RoofTile_OrangeVent.glb',
    category: 'model',
    sizeKB: 14,
  },
  {
  ...
  {
    id: 'modular/base',
    path: '/models/environment/modular/Props_Base.glb',
    category: 'model',
    sizeKB: 28,
  },
  {
  ...
  {
    id: 'modular/chest',
    path: '/models/environment/modular/Props_Chest.glb',
    category: 'model',
    sizeKB: 229,
  },
  {
    id: 'modular/detail_output',
    path: '/models/environment/modular/Details_Output.glb',
    category: 'model',
    sizeKB: 12,
  },
  {
    id: 'modular/detail_output_sm',
    path: '/models/environment/modular/Details_Output_Small.glb',
    category: 'model',
    sizeKB: 6,
  },
  ...
  {
    id: 'decal/poster_15',
    path: '/models/props/decals/poster_cx_15.glb',
    category: 'model',
    sizeKB: 43,
  },
  {
    id: 'decal/poster_16',
    path: '/models/props/decals/poster_cx_16.glb',
    category: 'model',
    sizeKB: 36,
  },
  ...
  // ============================================================================
  {
    ...
    path: '/models/environment/station-external/station06.glb',
    category: 'model',
    sizeKB: 366,
  },
];
