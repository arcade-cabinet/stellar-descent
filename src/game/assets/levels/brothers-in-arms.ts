...
export const BROTHERS_IN_ARMS_ASSETS: AssetEntry[] = [
  ...
  },
  {
    ...
    path: '/assets/models/environment/industrial/electrical_equipment_2.glb',
    category: 'model',
    sizeKB: 250,
  },
  {
  ...
  {
    id: 'prop/gravel_2',
    path: '/assets/models/props/debris/gravel_pile_hr_2.glb',
    category: 'model',
    sizeKB: 150,
  },
  {
    id: 'prop/brick_stack',
    path: '/assets/models/props/debris/bricks_stacked_mx_1.glb',
    category: 'model',
    sizeKB: 100,
  },
  {
  ...
  // -----------------------------------------------------------------------
  {
    ...
    path: '/assets/textures/levels/brothers-in-arms/Ground078_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/ground_normal',
    path: '/assets/textures/levels/brothers-in-arms/Ground078_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/ground_roughness',
    path: '/assets/textures/levels/brothers-in-arms/Ground078_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/sheet_metal',
    path: '/assets/textures/levels/brothers-in-arms/SheetMetal002_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/sheet_metal_normal',
    path: '/assets/textures/levels/brothers-in-arms/SheetMetal002_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/sheet_metal_roughness',
    path: '/assets/textures/levels/brothers-in-arms/SheetMetal002_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/scratches',
    path: '/assets/textures/levels/brothers-in-arms/Scratches003_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/scratches_normal',
    path: '/assets/textures/levels/brothers-in-arms/Scratches003_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/scratches_roughness',
    path: '/assets/textures/levels/brothers-in-arms/Scratches003_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/diamond',
    path: '/assets/textures/levels/brothers-in-arms/DiamondPlate003_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/diamond_normal',
    path: '/assets/textures/levels/brothers-in-arms/DiamondPlate003_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/diamond_roughness',
    path: '/assets/textures/levels/brothers-in-arms/DiamondPlate003_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/brothers/skybox',
    path: '/assets/textures/levels/brothers-in-arms/skybox.exr',
    category: 'texture',
    sizeKB: 2000,
  },
  ...
  {
    id: 'barricade/b_3',
    path: '/assets/models/props/modular/barricade_b_3.glb',
    category: 'model',
    sizeKB: 291,
  },
  {
    id: 'barricade/b_4',
    path: '/assets/models/props/modular/barricade_b_4.glb',
    category: 'model',
    sizeKB: 478,
  },
  {
  ...
  {
    id: 'decal/poster_5',
    path: '/assets/models/props/decals/poster_cx_5.glb',
    category: 'model',
    sizeKB: 68,
  },
  {
    id: 'decal/poster_9',
    path: '/assets/models/props/decals/poster_cx_9.glb',
    category: 'model',
    sizeKB: 43,
  },
  ...
  // -----------------------------------------------------------------------
  {
    ...
    path: '/assets/models/spaceships/Insurgent.glb',
    category: 'model',
    sizeKB: 3500,
  },
  {
    id: 'spaceship/striker',
    path: '/assets/models/spaceships/Striker.glb',
    category: 'model',
    sizeKB: 3000,
  },
];
