...
const EXTRACTION_PROPS: AssetEntry[] = [
  ...
  },
  {
    ...
    path: '/assets/models/props/pipes/pipe_mx_1.glb',
    category: 'model',
    sizeKB: 85,
  },
  {
    id: 'prop/extraction/pipe_4',
    path: '/assets/models/props/pipes/pipe_mx_2.glb',
    category: 'model',
    sizeKB: 85,
  },
  {
  ...
  },
  {
    ...
    path: '/assets/models/props/electrical/gear_mx_1.glb',
    category: 'model',
    sizeKB: 120,
  },
  {
    id: 'prop/extraction/gear_2',
    path: '/assets/models/props/electrical/gear_mx_2.glb',
    category: 'model',
    sizeKB: 120,
  },
  {
  ...
  },
  {
    ...
    path: '/assets/models/props/electrical/concrete_block_mx_1.glb',
    category: 'model',
    sizeKB: 90,
  },
  {
    id: 'prop/extraction/radio',
    path: '/assets/models/props/electrical/handheld_fm_radio_etx_1.glb',
    category: 'model',
    sizeKB: 60,
  },
];
...
const EXTRACTION_TEXTURES: AssetEntry[] = [
  // Ground042 - night surface terrain
  {
    ...
    path: '/assets/textures/levels/extraction/Ground042_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/extraction/ground_normal',
    path: '/assets/textures/levels/extraction/Ground042_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/extraction/ground_roughness',
    path: '/assets/textures/levels/extraction/Ground042_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 100,
  },
  ...
  // PaintedMetal013 - LZ markings
  {
    ...
    path: '/assets/textures/levels/extraction/PaintedMetal013_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/extraction/painted_normal',
    path: '/assets/textures/levels/extraction/PaintedMetal013_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/extraction/painted_roughness',
    path: '/assets/textures/levels/extraction/PaintedMetal013_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 100,
  },
  ...
  // Rubber002 - tire marks / landing pad
  {
    ...
    path: '/assets/textures/levels/extraction/Rubber002_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/extraction/rubber_normal',
    path: '/assets/textures/levels/extraction/Rubber002_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/extraction/rubber_roughness',
    path: '/assets/textures/levels/extraction/Rubber002_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 100,
  },
  ...
  // Asphalt007 - runway/landing strip
  {
    ...
    path: '/assets/textures/levels/extraction/Asphalt007_1K-JPG_Color.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/extraction/asphalt_normal',
    path: '/assets/textures/levels/extraction/Asphalt007_1K-JPG_NormalGL.jpg',
    category: 'texture',
    sizeKB: 200,
  },
  {
    id: 'tex/extraction/asphalt_roughness',
    path: '/assets/textures/levels/extraction/Asphalt007_1K-JPG_Roughness.jpg',
    category: 'texture',
    sizeKB: 100,
  },
  ...
  // Night sky HDRI
  {
    ...
    path: '/assets/textures/levels/extraction/skybox.exr',
    category: 'texture',
    sizeKB: 2000,
  },
];
...
const EXTRACTION_FENCES: AssetEntry[] = [
  {
    id: 'fence/b_1',
    path: '/assets/models/props/modular/fence_b_1.glb',
    category: 'model',
    sizeKB: 254,
  },
  {
    id: 'fence/b_pillar',
    path: '/assets/models/props/modular/fence_b_pillar.glb',
    category: 'model',
    sizeKB: 58,
  },
  {
    id: 'fence/e_1',
    path: '/assets/models/props/modular/fence_e_1.glb',
    category: 'model',
    sizeKB: 479,
  },
  {
    id: 'fence/e_2',
    path: '/assets/models/props/modular/fence_e_2.glb',
    category: 'model',
    sizeKB: 518,
  },
  {
    id: 'fence/e_pillar',
    path: '/assets/models/props/modular/fence_e_pillar_1.glb',
    category: 'model',
    sizeKB: 476,
  },
  {
    id: 'fence/e_corner',
    path: '/assets/models/props/modular/fence_e_pillar_1_corner.glb',
    category: 'model',
    sizeKB: 478,
  },
];
...
const EXTRACTION_MODULAR: AssetEntry[] = [
  {
    ...
    path: '/assets/models/environment/modular/Window_Wall_SideA.glb',
    category: 'model',
    sizeKB: 19,
  },
  {
    id: 'modular/window_wall_b',
    path: '/assets/models/environment/modular/Window_Wall_SideB.glb',
    category: 'model',
    sizeKB: 18,
  },
  {
    id: 'modular/3win_wall_a',
    path: '/assets/models/environment/modular/ThreeWindows_Wall_SideA.glb',
    category: 'model',
    sizeKB: 37,
  },
  {
    id: 'modular/3win_wall_b',
    path: '/assets/models/environment/modular/ThreeWindows_Wall_SideB.glb',
    category: 'model',
    sizeKB: 34,
  },
  {
  ...
  },
  {
    ...
    path: '/assets/models/environment/modular/RoofTile_Empty.glb',
    category: 'model',
    sizeKB: 4,
  },
  {
    id: 'modular/roof_plate2',
    path: '/assets/models/environment/modular/RoofTile_Plate2.glb',
    category: 'model',
    sizeKB: 22,
  },
  {
  ...
  },
  {
    ...
    path: '/assets/models/environment/modular/Props_ComputerSmall.glb',
    category: 'model',
    sizeKB: 38,
  },
  {
