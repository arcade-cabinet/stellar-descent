...
const MODEL_PATHS = {
  ...
  floorCeilingRtx2: '/assets/models/environment/station/floor_ceiling_rtx_2.glb',
  floorCeilingRtxCorner: '/assets/models/environment/station/floor_ceiling_rtx_1_corner.glb',
  ...
  wallRtx1: '/assets/models/environment/station/wall_rtx_1.glb',
  ...
  doorway3: '/assets/models/environment/station/doorway_hr_3_regular.glb',
  stationDoor: '/assets/models/environment/station/station_door.glb',

  // Garage doors (hangar bay)
  garageDoor1: '/assets/models/environment/station/garage_door_frame_hr_1.glb',
  garageDoor2: '/assets/models/environment/station/garage_door_frame_hr_2.glb',

  // Beams
  beamHorizontal1: '/assets/models/environment/station/beam_hc_horizontal_1.glb',
  beamHorizontal2: '/assets/models/environment/station/beam_hc_horizontal_2.glb',
  beamVertical: '/assets/models/environment/station/beam_hc_vertical_1.glb',
  ...
  // Platforms
  platformA1: '/assets/models/environment/station/platform_ax_1.glb',
  platformB1: '/assets/models/environment/station/platform_bx_1.glb',
  ...
  // Atmospheric
  hallway1: '/assets/models/props/atmospheric/hallway_1.glb',
  ...
  modFloorInner: '/assets/models/environment/modular/FloorTile_InnerCorner.glb',
  modWall1: '/assets/models/environment/modular/Wall_1.glb',
  modWall2: '/assets/models/environment/modular/Wall_2.glb',
  modDoorSingle: '/assets/models/environment/modular/Door_Single.glb',
  ...
  modStaircase: '/assets/models/environment/modular/Staircase.glb',
  ...
  // Station external
  stationExternal: '/assets/models/environment/station-external/station01.glb',
  ...
  electrical: '/assets/models/props/industrial/electrical_equipment_1.glb',
  machinery: '/assets/models/props/industrial/machinery_mx_1.glb',
  pipes: '/assets/models/props/industrial/pipes_hr_1.glb',
  door6: '/assets/models/props/industrial/door_hr_6.glb',
  door12: '/assets/models/props/industrial/door_hr_12.glb',
  door13: '/assets/models/props/industrial/door_hr_13.glb',
  ...
  // Decals
  poster11: '/assets/models/props/decals/poster_cx_11.glb',
  poster12: '/assets/models/props/decals/poster_cx_12.glb',
  poster13: '/assets/models/props/decals/poster_cx_13.glb',

  // Interactive element GLBs (replacing MeshBuilder primitives)
  modCapsule: '/assets/models/environment/modular/Props_Capsule.glb',
  ...
  doorSingle: '/assets/models/environment/modular/Door_Single.glb',
  doorDouble: '/assets/models/environment/modular/Door_Double.glb',
  doorWallSideA: '/assets/models/environment/modular/DoorSingle_Wall_SideA.glb',
  doorWallSideB: '/assets/models/environment/modular/DoorSingle_Wall_SideB.glb',
};
