...
import { getVoiceSynthesizer, REYES_VOICE, type VoicePlaybackHandle } from './VoiceSynthesizer';
...
const IN_MISSION_LINES: Record<string, DialogueEntry[]> = {
  objective_updated: [
    ...
    entry(
      'obj_update_3',
      'Prometheus has updated your mission parameters. Proceed to the marked location.'
    ),
  ],
  ...
  objective_complete: [
    entry(
      'obj_complete_1',
      'Good work, Cole. Objective complete. Stand by for further instructions.'
    ),
  ...
  hostiles_detected: [
    entry(
      'hostiles_1',
      'Sergeant, we are reading movement converging on your position. Weapons free.',
      DialoguePriority.HIGH
    ),
    entry(
      'hostiles_2',
      'Multiple contacts bearing down on you. Stay sharp.',
      DialoguePriority.HIGH
    ),
    entry(
      'hostiles_3',
      'Orbital confirms hostile signatures. They know you are there.',
      DialoguePriority.HIGH
    ),
  ],
  ...
  player_low_health_warning: [
    entry(
      'health_low_1',
      'Cole, your bio-readings are dropping. Find cover and stabilize.',
      DialoguePriority.HIGH
    ),
    entry(
      'health_low_2',
      'Sergeant, your vitals are concerning. Do not push it.',
      DialoguePriority.HIGH
    ),
  ],
  ...
  player_critical_warning: [
    entry(
      'health_crit_1',
      'Cole! Your vitals are critical! Fall back immediately!',
      DialoguePriority.CRITICAL
    ),
    entry(
      'health_crit_2',
      'Sergeant, you are not going to make it at this rate. Find medical supplies NOW.',
      DialoguePriority.CRITICAL
    ),
  ],
  ...
  reinforcements_incoming: [
    entry(
      'reinforce_1',
      'Heads up, Cole. Orbital shows a second wave forming. Dig in.',
      DialoguePriority.HIGH
    ),
  ...
  extraction_available: [
    entry(
      'extract_ready_1',
      'Extraction is available. Get to LZ Omega. Dropship is holding pattern.',
      DialoguePriority.CRITICAL
    ),
  ],
  ...
  extraction_countdown: [
    entry(
      'extract_count_1',
      'Dropship is on final approach. Two minutes to dust-off. Hold that LZ!',
      DialoguePriority.CRITICAL
    ),
    entry(
      'extract_count_2',
      'Sixty seconds! Keep them off the landing zone!',
      DialoguePriority.CRITICAL
    ),
    entry(
      'extract_count_3',
      'Dropship is down! Get on board, Sergeant! Move!',
      DialoguePriority.CRITICAL
    ),
  ],
  ...
  marcus_located: [
    entry(
      'marcus_found_1',
      'Prometheus confirms: that is Marcus. IFF is solid. Go get your brother, Cole.',
      DialoguePriority.HIGH
    ),
  ],
  ...
  fob_delta_lights_out: [
    entry(
      'fob_dark_1',
      'Cole, power grid just went dark across the base. Something tripped the breakers.',
      DialoguePriority.HIGH
    ),
  ...
  hive_entrance_found: [
    entry(
      'hive_found_1',
      'That is the entrance. Seismic readings are off the charts down there.',
      DialoguePriority.HIGH
    ),
    entry(
      'hive_found_2',
      'Once you go in, comms may be unreliable. You are on your own, Sergeant.',
      DialoguePriority.HIGH
    ),
  ],
  ...
  queen_detected: [
    entry(
      'queen_1',
      'Massive bio-signature detected ahead. That has to be the queen. End this, Cole.',
      DialoguePriority.CRITICAL
    ),
  ],
  ...
  queen_defeated: [
    entry(
      'queen_dead_1',
      'The hive mind signal just flatlined. You did it, Sergeant. The queen is dead.',
      DialoguePriority.CRITICAL
    ),
    entry(
      'queen_dead_2',
      'All hostile signatures are going erratic. The swarm is collapsing. Get out of there!',
      DialoguePriority.CRITICAL,
      800
    ),
  ],
  ...
  mission_complete: [
    entry(
      'complete_1',
      'Mission complete. Sergeant James Cole, you have done humanity proud.',
      DialoguePriority.CRITICAL
    ),
  ...
  mission_failed: [
    entry(
      'failed_1',
      'We have lost contact with Sergeant Cole. Scramble recovery team. Vasquez out.',
      DialoguePriority.CRITICAL
    ),
  ],
};
...
export class ReyesDialogueManager {
  ...
  private enqueue(dialogueEntry: DialogueEntry): Promise<void> {
    ...
    return new Promise<void>((resolve) => {
      ...
      if (this.currentPlayback?.isPlaying && dialogueEntry.priority > this.currentPriority) {
        this.currentPlayback.stop();
        this.currentPlayback = null;
        // Insert at front
