...
// node_modules/.pnpm/@babylonjs+core@8.49.1/node_modules/@babylonjs/core/Materials/PBR/openpbrMaterial.js
    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-UQT2V4US.js"), import("./openpbr.fragment-S6NOTOBY.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-VGWWPLST.js"), import("./openpbr.fragment-PEW4IFV5.js")]);
        }
...
//# sourceMappingURL=openpbrMaterial-W32KUBO3.js.map
