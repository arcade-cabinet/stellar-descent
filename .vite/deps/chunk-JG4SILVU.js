...
// node_modules/.pnpm/@babylonjs+core@8.49.1/node_modules/@babylonjs/core/Materials/standardMaterial.js
      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-GXBU72RB.js"), import("./default.fragment-VDAXPSKR.js")]);
          } else {
            await Promise.all([import("./@babylonjs_core_Shaders_default__vertex.js"), import("./@babylonjs_core_Shaders_default__fragment.js")]);
          }
...
//# sourceMappingURL=chunk-JG4SILVU.js.map
