import {
  ApplyPostProcess
} from "./chunk-7P3NNTBG.js";
import {
  PostProcess
} from "./chunk-FTNKZQKS.js";

// node_modules/.pnpm/@babylonjs+core@8.49.1/node_modules/@babylonjs/core/Misc/rgbdTextureTools.js
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRgbdTextureAsync = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGpu) {
        await import("./rgbdDecode.fragment-ISFLXWV7.js");
      } else {
        await import("./rgbdDecode.fragment-KP56KDKK.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-KI6Z4EVQ.js");
    } else {
      await import("./rgbdEncode.fragment-KPPGBSMU.js");
    }
...
//# sourceMappingURL=chunk-G2R725ZT.js.map
