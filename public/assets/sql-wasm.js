  ...
  initSqlJsPromise = new Promise((resolveModule, reject) => {
    ...
    f.onRuntimeInitialized = () => {
      ...
      var h = z(4),
        ...
        G = k('sqlite3_prepare_v2', 'number', ['number', 'string', 'number', 'number', 'number']),
        ...
        oc = k('sqlite3_bind_text', 'number', ['number', 'number', 'number', 'number', 'number']),
    ...
    if (ca) {
      ...
      ba
        ...
        (D = D.startsWith('blob:') ? '' : D.slice(0, D.replace(/[?#].*/, '').lastIndexOf('/') + 1)),
        ba &&
          (Fa = (a) => {
    ...
    function oa(a, b, c = 438) {
      ...
      b & 512 &&
        !h &&
        ((e = d), (e = 'string' === typeof e ? S(e, { $a: !0 }).node : e), cc(null, e, 0));
      b &= -131713;
      e = Tb({
        node: d,
        path: ja(d),
